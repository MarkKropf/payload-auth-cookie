...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "posts_rels" ADD CONSTRAINT "posts_rels_admin_users_fk" FOREIGN KEY ("admin_users_id") REFERENCES "public"."admin_users"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_rels" ADD CONSTRAINT "_posts_v_rels_admin_users_fk" FOREIGN KEY ("admin_users_id") REFERENCES "public"."admin_users"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "posts_rels_admin_users_id_idx" ON "posts_rels" USING btree ("admin_users_id");
  ...
  CREATE INDEX "_posts_v_rels_admin_users_id_idx" ON "_posts_v_rels" USING btree ("admin_users_id");
  ...
  CREATE INDEX "payload_preferences_rels_app_users_id_idx" ON "payload_preferences_rels" USING btree ("app_users_id");
